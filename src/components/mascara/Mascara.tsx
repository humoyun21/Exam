...
import { allDataStart, mascaraDataSuccess } from "../../slice/categories";


const Mascara: React.FC = () => {
  ...
  const BlushCategory = async () => {
    ...
    try {
      const res = await categories.mascaraProducts()
      dispatch(mascaraDataSuccess(res))
