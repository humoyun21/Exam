...
import { allDataStart, eyeShadowDataSuccess } from "../../slice/categories";


const EyeShadow: React.FC = () => {
  ...
  const BlushCategory = async () => {
    ...
    try {
      const res = await categories.eyeShadowProducts()
      dispatch(eyeShadowDataSuccess(res))
