...
import { allDataStart,  eyeLinerDataSuccess } from "../../slice/categories";


const Eyeliner: React.FC = () => {
  ...
  const BlushCategory = async () => {
    ...
    try {
      const res = await categories.eyeLinerProducts()
      dispatch(eyeLinerDataSuccess(res))
