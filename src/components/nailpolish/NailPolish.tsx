...
import { allDataStart,  nailPolishDataSuccess } from "../../slice/categories";


const NailPolish: React.FC = () => {
  ...
  const BlushCategory = async () => {
    ...
    try {
      const res = await categories.nailPolishCategory()
      dispatch(nailPolishDataSuccess(res))
